...
public final class ExtensionTool {
	...
	// Java 7 Way and back
	static final Set<String> ACCEPTED_AUDIO_EXTENSIONS = new HashSet<>(List.of("mp3"));
	static final Set<String> ACCEPTED_VIDEO_EXTENSIONS = new HashSet<>(List.of("mp4"));
	...
	public static final List<String> POPULAR_VIDEO_EXTENSIONS_LIST = Arrays.asList("mp4",  "avi",  "mov",
			"3gp", "webm","vob"/*, "yuv", "m4v", "svi", "3g2", "f4v", "f4p", "f4a", "f4b", "swf"*/);
