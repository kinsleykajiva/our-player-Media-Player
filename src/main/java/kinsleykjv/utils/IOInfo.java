...
import static kinsleykjv.utils.ExtensionTool.POPULAR_VIDEO_EXTENSIONS_LIST;
...
public class IOInfo {
	...
	public static Collection<File> listFilesInExplorerDirectory(final String directoryTarget){
		String userHome = System.getProperty("user.home");
		File fileObj =	new File(userHome + File.separator + directoryTarget.trim());

		Collection<File> allMovies = FileUtils.listFiles(fileObj, POPULAR_VIDEO_EXTENSIONS_LIST.toArray(new String[0]), true);
